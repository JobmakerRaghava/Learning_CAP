using {RAGS} from '../srv/srv';


annotate RAGS.EmployeeDetailsSet with
@(UI: {
...
annotate RAGS.EmployeeDetailsSet {
    status @Common: {
...
annotate RAGS.DepartmentSet with @UI: {LineItem: [{
    $Type: 'UI.DataField',
    Value: Department,
    Label: 'Department'
}, ], };

annotate RAGS.RegionSet with @UI: {LineItem: [{
    $Type: 'UI.DataField',
    Value: Region,
    Label: 'Region'
}, ], };
